...
RUN_NAME="imagenet1k_vit12_bmbuv_recipe_r64_s64_bs768_30ep_gpu${GPU_ID}"
...
'${PYTHON_BIN}' -m remote_lab.cli \
  --config configs/experiments/imagenet1k_vit12_bmbuv_recipe_r64_s64_bs768_30ep_v1.json \
