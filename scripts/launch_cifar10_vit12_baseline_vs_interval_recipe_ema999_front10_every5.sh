...
INTERVAL_RUN_DIR="${ROOT_DIR}/runs/cifar10_vit12_interval_b2048_recipe_ema999_front10_every5_gpu${INTERVAL_GPU}"
...
python -m remote_lab.cli \
  --config configs/experiments/cifar10_vit12_interval_reg_linear_lambda05_b2048_recipe_ema999_front10_every5_v1.json \
  --output-dir runs/cifar10_vit12_interval_b2048_recipe_ema999_front10_every5_gpu${INTERVAL_GPU}
