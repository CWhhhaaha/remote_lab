...
BASELINE_RUN_DIR="${ROOT_DIR}/runs/cifar10_vit6_baseline_gpu${BASELINE_GPU}"
INTERVAL_RUN_DIR="${ROOT_DIR}/runs/cifar10_vit6_interval_gpu${INTERVAL_GPU}"
...
python -m remote_lab.cli \
  --config configs/experiments/cifar10_vit6_baseline_v1.json \
  --output-dir runs/cifar10_vit6_baseline_gpu${BASELINE_GPU}
...
python -m remote_lab.cli \
  --config configs/experiments/cifar10_vit6_interval_reg_linear_lambda05_v1.json \
  --output-dir runs/cifar10_vit6_interval_gpu${INTERVAL_GPU}
