...
LINEAR_RUN_DIR="${ROOT_DIR}/runs/jigsaw_interval_linear_lambda05_gpu${LINEAR_GPU}"
...
python -m remote_lab.cli \
  --config configs/experiments/jigsaw_bert_small_encoder_interval_reg_linear_lambda05_v1.json \
  --output-dir runs/jigsaw_interval_linear_lambda05_gpu${LINEAR_GPU}
