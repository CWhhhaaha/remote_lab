...
- To launch the new `6-layer ViT CIFAR-10` comparison with baseline on GPU 2 and interval-regularization on GPU 6, run `bash scripts/launch_cifar10_baseline_vs_interval.sh`. Override GPUs with `BASELINE_GPU=... INTERVAL_GPU=...`.
